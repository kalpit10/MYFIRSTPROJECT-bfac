[MYFIRSTPROJECT-bfac] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [MYFIRSTPROJECT-bfac] container is NOT running**.

.. tip::
   You must have your [MYFIRSTPROJECT-bfac] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/kalpit10/rasberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40971  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='kalpit10'  \-\-env DOCKERUSERNAME='kalpit10'  \-\-env MQTTUSERNAME='kalpit.swami@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kalpit10/MYFIRSTPROJECT-bfac-amd64 (https://hub.docker.com/r/kalpit10/MYFIRSTPROJECT-bfac-amd64)
...
.. important::
   docker run -d -p 56079:56079 -p 38901:38901 -p 45261:45261 \-\-env TSS=0 \-\-env SOLUTIONNAME=MYFIRSTPROJECT-bfac \-\-env SOLUTIONDAG=solution_preprocessing_ml_dag-MYFIRSTPROJECT-bfac \-\-env GITUSERNAME=kalpit10  \-\-env GITREPOURL=https://github.com/kalpit10/rasberrypi \-\-env SOLUTIONEXTERNALPORT=56079  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=38901  \-\-env SOLUTIONVIPERVIZPORT=45261 \-\-env DOCKERUSERNAME='kalpit10'  \-\-env EXTERNALPORT=40971 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='kalpit.swami@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kalpit10/MYFIRSTPROJECT-bfac-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=45261
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=56079
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kalpit10/MYFIRSTPROJECT-bfac-amd64
...
It can be accessed by entering: http://localhost:38901
...
.. important::
   http://localhost:45261/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:45261/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:45261/<html file>
...
[MYFIRSTPROJECT-bfac] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/kalpit10/rasberrypi/tree/main/tml-airflow/dags/tml-solutions/MYFIRSTPROJECT-bfac
...
.. important::
   https://MYFIRSTPROJECT-bfac.readthedocs.io
...
.. important::
   solution_preprocessing_ml_dag-MYFIRSTPROJECT-bfac
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=56079, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46085, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37477, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46765, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41815, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40033, HPDEHOST=127.0.1.1, HPDEPORT=38521, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=39853

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8505-MYFIRSTPROJECT-bfac,solution_preprocessing_ml_dag-MYFIRSTPROJECT-bfac, python-preprocess-2783-MYFIRSTPROJECT-bfac,solution_preprocessing_ml_dag-MYFIRSTPROJECT-bfac, python-ml-3211-MYFIRSTPROJECT-bfac,solution_preprocessing_ml_dag-MYFIRSTPROJECT-bfac, python-predict-7283-MYFIRSTPROJECT-bfac,solution_preprocessing_ml_dag-MYFIRSTPROJECT-bfac, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
